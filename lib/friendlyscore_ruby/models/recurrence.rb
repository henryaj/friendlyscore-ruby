...
module FriendlyscoreClient
  class Recurrence
    ...
    # Amount of associated currency
    attr_accessor :average_amount

    # Amount variance
    attr_accessor :amount_variance

    # Collection of related transaction data
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'average_amount')
        self.average_amount = attributes[:'average_amount']
      end

      if attributes.has_key?(:'amount_variance')
        self.amount_variance = attributes[:'amount_variance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount_variance == o.amount_variance &&
    ...
    def hash
      [description, average_amount, amount_variance, transaction_ids].hash
    end
