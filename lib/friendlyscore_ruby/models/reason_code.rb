...
module FriendlyscoreClient
  class ReasonCode
    ...
    def valid?
      sentiment_validator = EnumAttributeValidator.new('String', ['Positive', 'Negative'])
    ...
    def sentiment=(sentiment)
      validator = EnumAttributeValidator.new('String', ['Positive', 'Negative'])
