...
module FriendlyscoreClient
  class FinancialMarkersData
    ...
    attr_accessor :cash_withdrawals
    ...
    def self.swagger_types
      {
        ...
        :'utility_payments' => :'HistoricalCummulativeStat',
        :'gambling' => :'AmountStat',
        :'cash_withdrawals' => :'AmountStat'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gambling')
        self.gambling = attributes[:'gambling']
      end

      if attributes.has_key?(:'cash_withdrawals')
        self.cash_withdrawals = attributes[:'cash_withdrawals']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gambling == o.gambling &&
          cash_withdrawals == o.cash_withdrawals
    end
    ...
    def hash
      [bank_charges, new_debt_indicator, credit_repayments, currency, returned_direct_debits, negative_balance_ratio, debt_management_indicator, debit_bank_transfer, summary_averages, utility_payments, gambling, cash_withdrawals].hash
    end
