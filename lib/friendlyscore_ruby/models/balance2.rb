...
module FriendlyscoreClient
  class Balance2
    ...
    # Balance type (compatible with OpenBanking 3.1 specification)
    attr_accessor :type
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['ClosingAvailable', 'ClosingBooked', 'ClosingCleared', 'Expected', 'ForwardAvailable', 'Information', 'InterimAvailable', 'InterimBooked', 'InterimCleared', 'OpeningAvailable', 'OpeningBooked', 'OpeningCleared', 'PreviouslyClosedBooked'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['ClosingAvailable', 'ClosingBooked', 'ClosingCleared', 'Expected', 'ForwardAvailable', 'Information', 'InterimAvailable', 'InterimBooked', 'InterimCleared', 'OpeningAvailable', 'OpeningBooked', 'OpeningCleared', 'PreviouslyClosedBooked'])
    ...
    def hash
      [amount, currency, type, custom_data, bank_slug, account_number, date_time].hash
    end
