...
module FriendlyscoreClient
  class Transaction
    ...
    def hash
      [external_transaction_id, name, type, amount, balance, currency, status, bank_slug, account_number, category, address_line, value_date_time, booking_date_time, custom_data].hash
    end
