...
module FriendlyscoreClient
  class SalaryExpectation
    ...
    # Date/time of expected payment
    attr_accessor :expected_pay_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'expected_pay_date')
        self.expected_pay_date = attributes[:'expected_pay_date']
      end

      if attributes.has_key?(:'pay_frequency')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount == o.amount &&
          expected_pay_date == o.expected_pay_date &&
    ...
    def hash
      [amount, expected_pay_date, pay_frequency].hash
    end
