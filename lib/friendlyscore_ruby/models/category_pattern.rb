...
module FriendlyscoreClient
  class CategoryPattern
    ...
    # Largest number of consecutive transactions
    attr_accessor :continuity

    # Months since transaction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'continuity')
        self.continuity = attributes[:'continuity']
      end

      if attributes.has_key?(:'recency')
    ...
    def hash
      [category, min, mean, max, variance, frequency, continuity, recency].hash
    end
