...
module FriendlyscoreClient
  class DtnDataProcessingSummary2
    # Date and time of last status change.
    attr_accessor :updated_at

    # Processing status of the posted piece of data
    attr_accessor :processing_status

    # Slug of the relevant data process or DTN (useful in URLs)
    attr_accessor :dtn_slug
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'processing_status')
        self.processing_status = attributes[:'processing_status']
      end

      if attributes.has_key?(:'dtn_slug')
        self.dtn_slug = attributes[:'dtn_slug']
      end
    end
    ...
    def valid?
      processing_status_validator = EnumAttributeValidator.new('String', ['failed', 'in_progress', 'finished'])
    ...
    def processing_status=(processing_status)
      validator = EnumAttributeValidator.new('String', ['failed', 'in_progress', 'finished'])
    ...
    def hash
      [updated_at, processing_status, dtn_slug].hash
    end
