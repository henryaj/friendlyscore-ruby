...
module FriendlyscoreClient
  class Account2
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['Business', 'Personal'])
      return false unless type_validator.valid?(@type)
      return false if @sub_type.nil?
      sub_type_validator = EnumAttributeValidator.new('String', ['ChargeCard', 'CreditCard', 'CurrentAccount', 'EMoney', 'Loan', 'Mortgage', 'PrePaidCard', 'Savings'])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ['ChargeCard', 'CreditCard', 'CurrentAccount', 'EMoney', 'Loan', 'Mortgage', 'PrePaidCard', 'Savings'])
    ...
    def hash
      [currency, name, bank_slug, type, sub_type, number].hash
    end
