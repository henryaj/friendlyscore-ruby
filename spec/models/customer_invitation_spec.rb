...
# Unit tests for FriendlyscoreClient::CustomerInvitation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerInvitation' do
  before do
    # run before each test
    @instance = FriendlyscoreClient::CustomerInvitation.new
  end
  ...
  describe 'test an instance of CustomerInvitation' do
    it 'should create an instance of CustomerInvitation' do
      expect(@instance).to be_instance_of(FriendlyscoreClient::CustomerInvitation)
    end
  end
